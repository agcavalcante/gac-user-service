...
const create_user_dto_1 = require("../component/user/create-user.dto");
const user_service_1 = require("../component/user/user.service");
let UserController = class UserController {
    ...
    async createUser(response, createUserDto) {
        try {
            const hashedPass = await (0, argon2_1.hash)(createUserDto.password, {
                type: 0,
                memoryCost: 2 ** 16,
                hashLength: 50,
            });
